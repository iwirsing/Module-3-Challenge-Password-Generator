...
function writePassword() {
  ...
  //check if there is any input for character type, if all false then
    ...
    //show selection choice and generate the password
